...
${CXX:-c++} -std=c++20 -Wall -Wextra -Werror -Ihost-tests/rss/stubs -Isrc/apps_local/rss -Ilib/RssParser -Itest/opds_feed/stubs host-tests/rss/test_cache.cpp src/apps_local/rss/RssCache.cpp src/apps_local/rss/RssTime.cpp -o "$BUILD/rss-cache"
"$BUILD/rss-cache"
